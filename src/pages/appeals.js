...
import Popup from "../components/Popup_inProgress"
...
const Appeals = () => {
  ...
  const appeals_footer = data_page.allContentfulFormPageFooter.nodes[1]
            ...
            <div className="desc_table">
              <div className="desc_cell">
                ...
                <text style={{ textAlign: "center" }}>
                  {renderRichText(appeals_footer.content, options_footer)}
                </text>
              </div>
            </div>
          </div>
